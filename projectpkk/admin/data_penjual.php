...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="data_penjual.php" class="logo">Haidar Motor <span class="lite">Admin</span></a>
      <!--logo end-->
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://bootstrapmade.com/">Haidar</a>
        </div>
    </div>
  </section>
